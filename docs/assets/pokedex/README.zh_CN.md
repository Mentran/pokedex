...
| 介绍 | PokeAPI `zh-hans` 图鉴文本，一句 | 介绍页只放第一句 |
| 小知识 | 同一来源的第二句 | 单独一页；没有第二句时显示「目前没有更多记录。」 |
...
开机先全屏播放耿鬼对尼多力诺（红蓝开场节奏，站位按封面立绘朝向），约 4 秒，任意键跳过，再进首页。首页四个入口。这套玩法用红色手持图鉴外壳（转轴、内屏、喇叭孔），不用模板的天空 / 草地 / 吉祥物。电量放在红色顶框右上角。进首页后循环播放「我是谁」同款 8-bit 宝可梦中心 BGM，音量 40、节奏约 0.75 倍；叫声音量 60，播叫声时会暂时打断。
...
**小知识：** 该只宝可梦的第二句图鉴。没有第二句时显示「目前没有更多记录。」这和首页「大木讲堂」的世界小知识池不是同一套。
