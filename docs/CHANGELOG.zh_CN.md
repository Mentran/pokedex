...
- 开机去掉浅绿色地面椭圆，只留角色脚下的深色落点影。图鉴条目在介绍后增加「小知识」页，用该只的第二句图鉴；17 只没有第二句时显示「目前没有更多记录。」
- 猜猜我是谁：黑色剪影猜谜，确定揭晓图鉴，上下换下一只剪影。大木讲堂人像改成上半身裁切，80px 放在左下或右下角。开机只播耿鬼对尼多力诺，约 4 秒，场地跟图鉴绿屏同色，进首页后再起 BGM。循环播放「我是谁」同款 8-bit 宝可梦中心 BGM，音量 40，叫声 60。
